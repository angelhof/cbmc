...
/// for the lengths are always added.
///
/// Concretely, if a builtin function supports **constraint generation**, it
...
/// }
/// ```
/// if the builtin function for concatenation supports constraint generation,
/// then the assertion is reachable.
///
/// If a builtin function supports **evaluation**, then adding the constraints
...
///
/// If the builtin function supports **constraint generation for the string
